...
from .views import blog, add_post, update_post, AddCategoryView, add_tag, update_category, preview_post, AboutView, post_by_slug, posts_by_category, posts_by_tag
