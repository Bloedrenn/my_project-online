...
urlpatterns = [
    path('post/<slug:slug>/view/', post_by_slug, name='post_by_slug'),
    path('category/<slug:category>/posts/', posts_by_category, name="posts_by_category"),
    path('tag/<slug:tag>/posts/', posts_by_tag, name="posts_by_tag"),
